  ...
  <div class="etapes">
    <div class="sally free">
      <div>
        ...
        <div class="plan">
          <iframe v-if="store.fond === 'Motif 1'" width="560" height="315" src="https://www.youtube.com/embed/qGibXhK7__o" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          <iframe v-else-if="store.fond === 'Motif 2'" width="560" height="315" src="https://www.youtube.com/embed/4veLvHrV2-0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>

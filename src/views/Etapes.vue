  ...
  <div class="etapes">
    <div class="sally free">
      <div>
        ...
        <div class="plan">
          <iframe v-if="store.fond === 'Motif 1'" width="560" height="315" src="https://www.youtube.com/embed/nkPXIdtc1fY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          <iframe v-else-if="store.fond === 'Motif 2'" width="560" height="315" src="https://www.youtube.com/embed/-LyVjHeCLDw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>
